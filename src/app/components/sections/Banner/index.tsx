  ...
  return (
    <section className='bg-main_black text-white text-center pt-8 pb-28 flex flex-col items-center gap-8'>
      <Limiter className='flex flex-col items-center'>
        <Title className='font-bold lg:px-0 w-[180px] lg:w-full' tag='h1'>Somos a Diagonal <span className='text-purple_40'>.</span></Title>
      ...
      <Limiter className='text-center flex flex-col items-center gap-4'>
        <p className='max-w-[344px] md:max-w-[608px]'>Nascemos para ajudar academias, estúdios, clínicas e marcas de bem-estar a crescerem com estratégias que unem branding e performance. Combinamos criatividade e dados para atrair, engajar e converter o público que busca qualidade de vida.</p>
