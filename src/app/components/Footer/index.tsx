      ...
      <div className='flex flex-col items-center gap-4 px-4 mb-12'>
        ...
        <div className='flex items-center w-full mb-4'>
          ...
          <div className='flex gap-4 justify-center lg:w-1/3 w-full'>
            {allSocialNetworksList.map((socialNetowrk:any, i) => ( <Link href={socialNetowrk.url} target='_blank' key={i}><socialNetowrk.icon className='text-purple_40 '/></Link>))}
          </div>
        ...
        <span className='flex justify-center items-center gap-2 text-xs'><BiEnvelope className='text-purple_40 text-2xl'/> contato@diagonal.ag</span>
      </div>
